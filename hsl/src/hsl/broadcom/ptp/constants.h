...
#define DEFAULT_NO_RESET_CLOCK       	PTP_FALSE
...
#define DEFAULT_UTC_VALID		PTP_FALSE
...
#define DEFAULT_PARENTS_STATS			PTP_FALSE

/* features, only change to refelect changes in implementation */
#define PTP_NUMBER_PORTS      	20
#define PTP_MASTER_PORT_NUMBER  2   
#define NUMBER_PORTS      	1
#define VERSION_PTP       	2
#define TWO_STEP_FLAG    	0x02
#define BOUNDARY_CLOCK    	PTP_FALSE
#define SLAVE_ONLY		PTP_FALSE
#define NO_ADJUST		PTP_FALSE

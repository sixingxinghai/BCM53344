...
{HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 1.\n");
	int s_msb;
	double ns_msb;
	int entire;
	char *p_lsb, *p_msb;
	Boolean negative = PTP_FALSE;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 2.\n");
	...
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 2.1.\n");

	if (!negative) {
		/* Positive case */
		
		HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 2.2.\n");

		/* fractional nanoseconds are excluded (see 5.3.2) */
		bigint.lsb = bigint.lsb >> 16;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 2.3.\n");
		/*
		 * copy two least significant octet of msb to most
		 * significant octet of lsb
		 */
		*(p_lsb + 2) = *p_msb;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 3.\n");
		*(p_lsb + 3) = *(p_msb + 1);
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 4.\n");
		bigint.msb = bigint.msb >> 16;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 5.\n");

		internal->nanoseconds = bigint.lsb % 1000000000;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 6.\n");
		internal->seconds = bigint.lsb / 1000000000;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 7.\n");

		/* (2^32 / 10^9) = 4,294967296 */
		s_msb = 4 * bigint.msb;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 8.\n");
		ns_msb = 0.294967296 * (double)bigint.msb;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 9.\n");
		entire = (int)ns_msb;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 10.\n");
		s_msb += entire;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 11.\n");
		ns_msb -= entire;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 12.\n");
		ns_msb *= 1000000000;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 13.\n");
		internal->nanoseconds = (float)internal->nanoseconds + 
			(float)ns_msb;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 14.\n");
		internal->seconds += s_msb;
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 15.\n");
		normalizeTime(internal);
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 16.\n");
	...
	HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_INFO, "integer64 to internal time 17.\n");
...
void 
normalizeTime(TimeInternal * r)/******** djg ???  */
{

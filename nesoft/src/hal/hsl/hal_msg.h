...
#define HAL_MSG_VSI_BASE                           HAL_MSG_BASE_MSG(1500)
#define HAL_MSG_VSI_MSG(n)                         (HAL_MSG_VSI_BASE  + (n))
#define HAL_MSG_VLL_CREATE	                        HAL_MSG_VSI_MSG(1)
#define HAL_MSG_VLL_ADD_PORT	                    HAL_MSG_VSI_MSG(2)
#define HAL_MSG_VLL_DELETE                          HAL_MSG_VSI_MSG(3)
#define HAL_MSG_VSI_CREATE                          HAL_MSG_VSI_MSG(10)
#define HAL_MSG_VSI_ADD_PORT	                    HAL_MSG_VSI_MSG(11)
#define HAL_MSG_VSI_DELETE_PORT	                    HAL_MSG_VSI_MSG(12)
#define HAL_MSG_VSI_DELETE                          HAL_MSG_VSI_MSG(13)
#define HAL_MSG_AC_ADD                              HAL_MSG_VSI_MSG(20)
#define HAL_MSG_AC_DELETE                           HAL_MSG_VSI_MSG(21)
#define HAL_MSG_VC_ADD                              HAL_MSG_VSI_MSG(30)
#define HAL_MSG_VC_DELETE                           HAL_MSG_VSI_MSG(31)

#define HAL_MSG_TUN_BASE                           HAL_MSG_BASE_MSG(1550)
#define HAL_MSG_TUN_MSG(n)                         (HAL_MSG_TUN_BASE  + (n))
#define HAL_MSG_TUN_ADD	                           HAL_MSG_TUN_MSG(1)
#define HAL_MSG_TUN_DELETE	                       HAL_MSG_TUN_MSG(2)
...
struct hal_msg_ac
{
    ...
    unsigned int port_id;  //card|port_num
    unsigned short ctag;//vlan
    unsigned short stag;
};

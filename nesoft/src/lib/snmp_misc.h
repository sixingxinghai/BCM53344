...
#ifndef _PACOS_SNMP_MISC_H
#define _PACOS_SNMP_MISC_H
...
/* LdpEntityOperStatus & LdpLspFecOperStatus MPLS-LDP-MIB rfcXXX */
#define SNMP_AG_OPER_UNKNOWN                 1
#define SNMP_AG_OPER_ENABLED                 2
#define SNMP_AG_OPER_DISABLED                3
#define SNMP_AG_OPER_IN_USE     SNMP_AG_OPER_ENABLED
#define SNMP_AG_OPER_NOT_IN_USE SNMP_AG_OPER_DISABLED

/* LdpEntityAdminStatus MPLS-LDP-MIB rfcXXX */
#define SNMP_AG_ADMIN_ENABLE                 1
#define SNMP_AG_ADMIN_DISABLE                2
...
/* MplsLdpLabelType MPLS-TC-MIB rfcXXX */
#define SNMP_AG_LBL_TYPE_generic        1
#define SNMP_AG_LBL_TYPE_atm            2
#define SNMP_AG_LBL_TYPE_frameRelay     3
...
typedef struct snmp_addr_index {
  union {
    u_int8_t            in_addr[16];

...
cli_mode_str (int mode)
{
  switch (mode)
    ...
    case CTRL_CHNL_MODE:
      return "Control Channel Configuration";
    case CTRL_ADJ_MODE:
      return "Control Adjacency Configuration";
#endif
    case KEYCHAIN_MODE:
...
#ifdef HAVE_LMP
    case LMP_MODE:
      return "LMP Configuration";
      break;
#endif /* HAVE_LMP */
#ifdef HAVE_RPVST_PLUS
    case RPVST_PLUS_CONFIG_MODE:
      return "RPVST-PLUS configuration";
      break;
#endif /* HAVE_RPVST_PLUS */

#ifdef HAVE_G8032
    case G8032_CONFIG_MODE:
       return "g8032 configure switching";
       break;
     case G8032_CONFIG_VLAN_MODE:
       return "G8032 vlan configuration";
       break;
#endif /* HAVE_G8032*/

#if defined (HAVE_PROVIDER_BRIDGE) || defined (HAVE_B_BEB)
    case TE_MSTI_CONFIG_MODE:
      return "TE MSTI configuration";
      break;
  ...
  break;
  case LSP_GRP_MODE:
  return "LSP protect group configuration";
  break;
  case LSP_OAM_MODE:
  return "LSP oam configuration";
  break;
  case AC_MODE:
  return "AC configuration";
  break;
  case RPORT_MODE:
  return "RPORT configuration";
  break;
  case TUN_MODE:
  ...
  case OAM_1731_MODE:
  return "Oam_1731 mode configuration";
  break;

  case SEC_MODE:
  return "SEC mode configuration";
  break;

  case MEG_MODE:
  return "MEG configuration";
  break;
  case PTP_MODE:
  return "PTP configuration";
  break;
  case PTP_PORT_MODE:
  return "PTP port configuration";
  break;
#ifdef HAVE_CUSTOM1
    case VLAN_MODE:
    ...
    case ETH_CFM_PBB_MODE:
      return "ethernet cfm pbb configuration";
      break;
#endif /* HAVE_I_BEB || HAVE_B_BEB */
    case ETH_CFM_VLAN_MODE:
      return "ethernet cfm vlan configuration";
      break;
#ifdef HAVE_PBB_TE
    case ETH_CFM_PBB_TE_MODE:
      return "ethernet cfm pbb-te configuration";
      break;
#endif /* HAVE_PBB_TE */
#endif /* HAVE_CFM */
#ifdef HAVE_G8031
    case G8031_CONFIG_VLAN_MODE:
      return "g8031 vlan mode configuration";
      break;
    case G8031_CONFIG_SWITCHING_MODE:
      return "g8031 eps switching mode configuration";
      break;
#endif /* HAVE_G8031*/
#ifdef HAVE_I_BEB
    case PBB_ISID_CONFIG_MODE:
      return "pbb isid configuration";
      break;
#endif /* HAVE_I_BEB */
#ifdef HAVE_PBB_TE
    case PBB_TE_VLAN_CONFIG_MODE:
      return "pbb-te vlan configuration";
      break;
#if defined HAVE_I_BEB && defined HAVE_B_BEB
    case PBB_TE_ESP_IF_CONFIG_MODE:
      return "pbb-te tesi esp configuration";
      break;
#endif /* HAVE_I_BEB && HAVE_B_BEB */
#endif /* HAVE_PBB_TE */
#if ((defined HAVE_CFM)&& (defined HAVE_I_BEB) && (defined HAVE_B_BEB) && \
         (defined HAVE_PBB_TE))
    case ETH_PBB_TE_EPS_CONFIG_SWITCHING_MODE:
      return "pbb-te configure switching";
      break;
    ...
    case CVLAN_REGIST_MODE:
      ...
      break;
#endif
    case EVC_SERVICE_INSTANCE_MODE:
      return "EVC Service Instance configuration";
      break;
    ...
    case FIREWALL_MODE:
      ...
      break;
#endif /* HAVE_FIREWALL */
    case TARGETED_PEER_MODE:
      return "Targeted Peer Configuration";
      break;
    default:
      return "";
    }
...
cli_prompt_str (int mode)
{
  switch (mode)
...
#ifdef HAVE_G8032
    case G8032_CONFIG_MODE:
      return "(g8032-config-switch)";
      break;
    case G8032_CONFIG_VLAN_MODE:
      return "(g8032-config-vlan)";
      break;
#endif /*HAVE_G8032*/

#if defined (HAVE_PROVIDER_BRIDGE) || defined (HAVE_B_BEB)
    case TE_MSTI_CONFIG_MODE:
      return "(config-te-msti)";
      break;
#endif /*(HAVE_PROVIDER_BRIDGE) ||(HAVE_B_BEB)*/
      case PW_MODE:
      return "(config-pw)";
      ...
      break;
	  case LSP_GRP_MODE:
      return "(config-lsp-prot-grp)";
      break;
	  case LSP_OAM_MODE:
      return "(config-lsp-oam)";
      break;
      case AC_MODE:
      return "(config-ac)";
      break;
    ...
    case ETH_CFM_MODE:
      ...
      break;
    case ETH_CFM_VLAN_MODE:
      return "(config-cfm-vlan)";
      break;

#if defined HAVE_I_BEB || defined HAVE_B_BEB
    case ETH_CFM_PBB_MODE:
      return "(config-ether-cfm-pbb)";
      break;
#endif /* HAVE_I_BEB || HAVE_B_BEB */
#endif /* HAVE_CFM */
#ifdef HAVE_G8031
    case G8031_CONFIG_SWITCHING_MODE:
      return "(g8031-config-switching)";
      break;
    case G8031_CONFIG_VLAN_MODE:
      return "(g8031-config-vlan)";
      break;
#endif /* HAVE_G8031*/
#ifdef HAVE_I_BEB
    case PBB_ISID_CONFIG_MODE:
...
#ifdef HAVE_PBB_TE
    case PBB_TE_VLAN_CONFIG_MODE:
      return "(pbb-te-config)";
      break;
#if defined HAVE_I_BEB && defined HAVE_B_BEB
    case PBB_TE_ESP_IF_CONFIG_MODE:
      return "(pbb-te-esp-if-config)";
      break;
#endif /* HAVE_I_BEB && HAVE_B_BEB */
#endif /* HAVE_PBB_TE */
#ifdef HAVE_CFM
#ifdef HAVE_PBB_TE
    case ETH_CFM_PBB_TE_MODE:
      return "(config-ether-cfm-pbb-te)";
      break;
#endif /* HAVE_PBB_TE */
#endif /* HAVE_CFM */
         ...
         (defined HAVE_PBB_TE))
    case ETH_PBB_TE_EPS_CONFIG_SWITCHING_MODE:
      return "(pbb-te-config-switching)";
      break;
#endif /* #if ((defined HAVE_CFM)&& (defined HAVE_I_BEB) && (defined HAVE_B_BEB) && (defined HAVE_PBB_TE)) */
    case CVLAN_REGIST_MODE:
...
#endif /* HAVE_FIREWALL */
    case TARGETED_PEER_MODE:
      return "(config-router-targeted-peer)";
      break;
    default:
      return "";
      break;
...
cli_port_reflect (char *buf)
{
  ...
  /* Check port type.  */
  if (pal_strcmp (buf + index, "XFPORT") == 0)
    pal_snprintf (buf + index, MAX_TOKEN_LENGTH, "<1-%d>", npf_fastcount ());
  else if (pal_strcmp (buf + index, "XGPORT") == 0)
    pal_snprintf (buf + index, MAX_TOKEN_LENGTH, "<1-%d>", npf_gigacount ());
  else if (pal_strcmp (buf + index, "XXPORT") == 0)
    pal_snprintf (buf + index, MAX_TOKEN_LENGTH, "<1-%d>",
                  npf_fastcount() + npf_gigacount());
  else if (pal_strcmp (buf + index, "XAPORT") == 0)
    pal_snprintf (buf + index, MAX_TOKEN_LENGTH, "<1-%d>", npf_portcount ());
  else if (pal_strcmp (buf + index, "XEPORT") == 0)
    pal_snprintf (buf + index, MAX_TOKEN_LENGTH, "<1-%d>",
                  npf_portcount() - npf_fastcount() - npf_gigacount());
  else if (pal_strcmp (buf + index, "XBLOCK") == 0)
    pal_snprintf (buf + index, MAX_TOKEN_LENGTH, "<1-%d>", escm_numlblock ());
}
#endif /* HAVE_CUSTOM1 */

...
#ifdef HAVE_CUSTOM1
      else if (pal_strstr (buf, "PORT") || pal_strstr (buf, "BLOCK"))
        {
                      ...
                      char *desc_str, char *short_str, char *str)
{
  ...
  if (mode == EXEC_PRIV_MODE)
    {
      privilege = PRIVILEGE_VR_MAX;
      mode = EXEC_MODE;
    }
  else
    privilege = PRIVILEGE_NORMAL;
...
#ifdef HAVE_TUNNEL
  else if (! pal_strncmp (iftype, "t", 1))
    zsnprintf (buf, bufsiz, "%s%s", PAL_TUNNEL_PREFIX, ifnum);
#endif /* HAVE_TUNNEL. */
...
{
  cli_out (cli,
           "PacOS CLI provides advanced help feature.  When you need help,\n\
  ...
  switch (cli->mode)
    ...
    case EXEC_MODE:
      if (CHECK_FLAG (cli->flags, CLI_FROM_PVR))
        {
          cli->vr = apn_vr_get_privileged (cli->zg);

...
#ifndef _PACOS_PLIST_H
#define _PACOS_PLIST_H
...
/* Prototypes. */
void prefix_list_add_hook (struct apn_vr *, void (*func) (void));
void prefix_list_delete_hook (struct apn_vr *, void (*func) (void));

struct prefix_list *prefix_list_lookup (struct apn_vr *, afi_t, char *);
...
int prefix_bgp_orf_set (struct apn_vr *, char *, afi_t, struct orf_prefix *,
                        int, int);
void prefix_bgp_orf_remove_all (struct apn_vr *, char *);
int prefix_bgp_show_prefix_list (struct apn_vr *, struct cli *, afi_t, char *);

void prefix_list_delete (struct prefix_list *);
struct prefix_list * prefix_list_get (struct apn_vr *, afi_t, char *);

int prefix_list_install (struct apn_vr *, afi_t, char *, int, struct prefix *,
                         u_int32_t, u_int32_t, u_int32_t, int);
int prefix_list_uninstall (struct apn_vr *, afi_t, char *, struct prefix *,
                           int, u_int32_t, u_int32_t, u_int32_t);
int config_encode_prefix_ipv4 (struct apn_vr *vr, cfg_vect_t *cv);
int config_write_prefix_ipv4 (struct cli *);
#ifdef HAVE_IPV6
int config_encode_prefix_ipv6 (struct apn_vr *vr, cfg_vect_t *cv);
int config_write_prefix_ipv6 (struct cli *);
#endif /* HAVE_IPV6 */

void prefix_list_init (struct lib_globals *);
void prefix_list_finish (struct apn_vr *);
int config_encode_prefix_ipv4 (struct apn_vr *vr, cfg_vect_t *cv);

#endif /* _PACOS_PLIST_H */

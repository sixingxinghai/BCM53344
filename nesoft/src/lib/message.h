...
#ifndef _PACOS_MESSAGE_H
#define _PACOS_MESSAGE_H
...
int message_header_encode (u_char **pnt, u_int16_t *size,
                            struct sockaddr_l2 *skhdr);
int message_header_decode (u_char **pnt, u_int16_t *size,
                            struct sockaddr_l2 *skhdr);

#endif /* _PACOS_MESSAGE_H */

...
/* pal_socket.h -- PacOS PAL socket and associated operations
   definitions.  */
...
#define PAL_IPPROTO_APNP                IPPROTO_APNP
...
#define PAL_IPPROTO_APNP                IP_IPPROTO_APNP

...
/*
  pal_socket.c -- PacOS PAL socket and associated operations definitions
  for Linux
*/
...
*/
#if defined HAVE_RTADV || defined HAVE_MCAST_IPV6
result_t
...
{
#if defined (HAVE_MULTIPLE_FIB) || defined (HAVE_IPNET)
  socklen_t len = sizeof (int);
#endif
...
{
  return setsockopt (sock, IPPROTO_IPV6, IPV6_NEXTHOP, NULL, (int) NULL);
}

result_t
pal_sock_set_ipv6_nexthop (pal_sock_handle_t sock, struct pal_in6_addr *addr)
{
  return setsockopt (sock, IPPROTO_IPV6, IPV6_NEXTHOP, addr,
